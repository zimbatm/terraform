...
//	}
//
//	resp, err := cdnEndpointsClient.Create(name, cdnEndpoint, profileName, resGroup, make(<-chan struct{}))
//	if err != nil {
//		return err
//	}
//
...
//			https_port := v.(int)
//			properties.HTTPSPort = azure.Int32(int32(https_port))
//		}
//
//		if v, ok := data["http_port"]; ok {
//			http_port := v.(int)
//			properties.HTTPPort = azure.Int32(int32(http_port))
//		}
//
